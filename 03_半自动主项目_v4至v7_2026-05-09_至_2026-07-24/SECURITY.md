...
Only the version at `main` (currently v7.5) receives security updates. (v7.1 note: the paper-trading page `/paper` is strictly read-only — it never places orders and never calls the paid reeval API.)
