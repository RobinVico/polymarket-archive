...
if __name__ == "__main__":
    ...
    log.info("Monitor: 每 30 秒 | TP: 事件型 翻倍(2×avg)先到则全卖, 否则0.92卖半(后半跌<0.78再卖)/收敛≤3天 0.88/其余 0.90 或 +100% | SL: 收敛=回撤20%(≤3天12%)+确认→重评 / 混合=回撤35%+确认→【直接平仓不走重评】(v7.4.5) / 事件=入场-60%+$0.05地板→重评 / 未分类当混合")
